...
if (crtKmer>=(int)(num-kmerSize+1)) {cout<<"[dfs]crtKmer "<<crtKmer<<endl;exit(1);}
...
//}
#pragma omp parallel default(none) shared(cout,kmerSize,pool,ioh,trie,pools2bacs,reads,numReads,out,numSearch,numHit) private(numPools,pools,numBacs,bacs,crtKmer,pos,kmerPos,orient,kmers,kmersInHash,orientation/*,minCorrections,correction*/) 
{
ostringstream os;
